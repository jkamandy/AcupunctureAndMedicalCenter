...
//   };
  ...
  return (
    <div className='relative z-0 w-full h-auto'>
        ...
        <video 
          className={` fixed top-1/2 left-1/2 opacity-90 blur-lg transform -translate-x-1/2 -translate-y-1/2 min-w-full min-h-full object-cover transition duration-500 ease-in-out ${isVisible ? "backdrop-blur-sm" : "blur-lg"}`}
          autoPlay 
          muted 
          loop 
          playsInline
