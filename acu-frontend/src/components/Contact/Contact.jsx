...
const Contact = ({ title, body, images }) => {
  ...
  return (
      <>
        <div className={`p-8 relative flex w-[80%] h-auto bg-multi-gradient hover:bg-opacity-50 hover:[transition:color_0.3s_ease-in-out;] rounded-lg`}>
          <div className=' flex items-center justify-center w-1/2'>
            <div className='flex flex-col items-center justify-center'>
                <h1 className='text-[85px] font-medium font-spartan tracking-[-3px] flex gap-12 drop-shadow-md'>Contact Us</h1>
                <span className='font-spartan text-center font-light'>(949)-206-1040  •  30212 Tomas, Suite 180</span>
                <div className='flex w-full items-center justify-center mt-6 [&_img:not(:first-of-type)]:ml-5'>
                    <img src={ins}></img>
                    <img src={yp}></img>
                    <img src={fb}></img>
                    <img src={ml}></img>
                ...
                <div className='flex flex-col items-center justify-center mt-8'>
                    <span className='font-spartan text-center font-light'>Monday - Friday: 8:00 - 6:00 pm</span>
                    <span className='font-spartan text-center font-light'>Saturday: 8:00 - 1:00 pm</span>
                    <span className='font-spartan text-center font-light'>Sunday: Closed</span>
                </div>
